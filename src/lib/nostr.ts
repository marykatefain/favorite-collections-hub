...
8 rank: 5,
        ...
        },
        {
          ...
          title: "Twin Peaks",
          type: "tvshow",
          imageUrl: "https://images.unsplash.com/photo-1516893842880-5d8aada7ac05",
          score: 86,
          collections: 585,
        },
        {
          ...
          title: "Black Mirror",
          type: "tvshow",
          imageUrl: "https://images.unsplash.com/photo-1515462277126-2dd0c162007a",
          score: 85,
          collections: 565,
        },
        {
      ...
      const articles = [
        ...
        },
        {
          ...
          type: "article",
          imageUrl: "https://images.unsplash.com/photo-1611273426858-450e7f08d071",
          score: 88,
          collections: 625,
        },
        {
          ...
          type: "article",
          imageUrl: "https://images.unsplash.com/photo-1639152201736-0c903fde4d44",
          score: 87,
          collections: 600,
        },
        {
      ...
      // Sort by score for the "all" view
      allItems.sort((a, b) => b.score - a.score);
      
      // Assign ranks for the "all" view
      allItems.forEach((item, index) => {
        item.rank = index + 1;
      });
      
      // Return appropriate category based on the request
      if (category === "movie") {
        resolve(movies);
